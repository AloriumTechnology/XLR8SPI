 ...
 */
#ifndef XLR8_Sd2Card_h
#define XLR8_Sd2Card_h
/**
 * \file
 * Sd2Card class
 */
...
class XLR8_Sd2Card {
 public:
  ...
  XLR8_Sd2Card(void) : errorCode_(0), inBlock_(0), partialBlockRead_(0), type_(0) {}
